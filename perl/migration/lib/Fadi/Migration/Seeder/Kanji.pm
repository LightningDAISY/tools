...
#
# my $random_string = Fadi::Migration::Seeder::Kanji->new->randomString(100);
#
sub randomString
{
	...
	for(my $i=$length; $i; $i--)
	{
		$result .= $chars[int rand scalar @chars];
	}
	$result
}
